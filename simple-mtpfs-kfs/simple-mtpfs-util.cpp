...
//namespace std {
//
//string build_path(vector<string> path_cnps, int size){
//    string partial;
//    for (int i = 0; i < size; i++) {
//        partial.append("/");
//        partial.append(path_cnps.at(i));
//    }
//    return partial;
//}
//
//vector<string> pathComponents(string str, long &num_cns){
//    vector<string> path_components;
//    istringstream stream(str);
//    string cn;
//    int i = 0;
//    // also deals with double slashes
//    while (std::getline(stream, cn, '/')) {
//        if (!cn.empty()) {
//            path_components.push_back(cn);
//            ++i;
//        }
//    }
//    num_cns = i;
